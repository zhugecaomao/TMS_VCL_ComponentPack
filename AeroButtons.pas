...
begin
  ...
  begin
    ...
    TButtonGlyph(FGlyph).Draw(FCanvas, R, Offset, Caption, FLayout, FMargin, FSpacing, State, False,
      DrawTextBiDiModeFlags(0) or WordBreakFlag[WordWrap], nil, -1);
  ...
  begin
    ...
    TButtonGlyph(FGlyph).Draw(FCanvas, R, Point(0,0), Caption, FLayout, FMargin,
      FSpacing, State, False, DrawTextBiDiModeFlags(0) or WordBreakFlag[WordWrap], nil, -1);
...
begin
  ...
  begin
    ...
    TButtonGlyph(FGlyph).Draw(FCanvas, R, Offset, Caption, bl, -1, Spacing, State, False,
      DrawTextBiDiModeFlags(0) or WordBreakFlag[WordWrap], Images, ImageIndex);
  ...
  begin
    ...
    TButtonGlyph(FGlyph).Draw(FCanvas, R, Point(0,0), Caption, blGlyphLeft, -1,
      4, State, False, DrawTextBiDiModeFlags(0) or WordBreakFlag[WordWrap], Images, ImageIndex);
...
begin
  ...
  begin
    ...
    TButtonGlyph(FGlyph).Draw(Canvas, PaintRect, Offset, Caption, FLayout, FMargin,
      FSpacing, FState, Transparent, DrawTextBiDiModeFlags(0), nil, -1);
  end;
end;
