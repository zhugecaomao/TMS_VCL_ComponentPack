...
uses
  Classes, Windows, Controls, Forms, Graphics, Messages, StdCtrls, SysUtils, Menus, AdvGDIP;
...
var
  PForm: TCustomForm;
begin
  Result := not (csDesigning in ComponentState) and ThemeServices.ThemesEnabled and
