...
type
  ...
  published
    ...
    property DropDownMemoColor: TColor read FDropDownMemoColor write FDropDownMemoColor default clWindow;
...
begin
  ...
  begin
    ...
    FMemo.Color := FDropDownMemoColor;
  end;
end;
