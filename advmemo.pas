...
const
  ...
  BLD_VER = 5; // Build nr.
  DATE_VER = 'Mar, 2011'; // Month version
...
begin
  ...
  begin
    ...
    if (ssShift in Shift) then  // Restricting Selection to end.
...
{$ENDIF}
          ...
          begin
            ...
            begin
              ...
              LineCanvas.MoveTo(rct1.left, FCellSize.H -1);
              LineCanvas.LineTo(rct1.Left + FCellSize.W * length(s2), FCellSize.H -1);
            end;
...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      //outputdebugstring('backup style');
    end
    else
    begin
      FLetRefresh := False;
      LineStyle := GetUpStyle(TopLine);
      //outputdebugstring('get up style');
      FLetRefresh := True;
...
{$IFDEF FREEWARE}
    ...
    Canvas.TextOut(eRect.Left, eRect.Bottom - 14, 'copyright © 2010 tmssoftware.com');
