...
begin
  inherited;
  if not (csDesigning in ComponentState) and CheckBox.Visible and (CheckBox.Action <> caNone) and CheckBox.Checked then
...
begin
  ...
  begin
    ...
    if Assigned(FGroupBox.OnCheckBoxClick) then
      FGroupBox.OnCheckBoxClick(FGroupBox);
  end;
end;
