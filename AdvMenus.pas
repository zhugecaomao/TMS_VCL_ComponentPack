...
{$ENDIF}
  ...
  IAdvMenu = interface
    ...
    { Public }
    property MenuStyler: TCustomAdvMenuStyler read GetMenuStyler write
      SetMenuStyler;
    property Opacity: Byte read GetOpacity write SetOpacity;
    property ShowNotes: Boolean read GetShowNotes write SetShowNotes;
    property IntlKeybShortCuts: Boolean read GetIntlKeybShortCuts write
      SetIntlKeybShortCuts;
  end;
  ...
  protected
    ...
    property GlyphPosition: TGlyphPosition read FGlyphPosition write
      SetGlyphPosition default gpLeft;
  public
    constructor Create;
  ...
  published
    ...
    property DownColor
      : TColor read FDownColor write SetDownColor default $00B59285;
    property DownColorTo
      : TColor read FDownColorTo write SetDownColorTo default clNone;
    property HoverColor
      : TColor read FHoverColor write SetHoverColor default $00D2BDB6;
    property HoverColorTo
      : TColor read FHoverColorTo write SetHoverColorTo default
      clNone;
    property GradientDirection
      : TGradientDirection read FGradientDirection write
      SetGradientDirection default gdVertical;
    property BorderColor
      : TColor read FBorderColor write SetBorderColor default clNone;
    property DownBorderColor
      : TColor read FDownBorderColor write FDownBorderColor default
      $006A240A;
    property HoverBorderColor
      : TColor read FHoverBorderColor write FHoverBorderColor default
      $006A240A;
    property CaptionFont: TFont read FCaptionFont write SetCaptionFont;
    property UseSystemFont
      : Boolean read FUseSystemFont write SetUseSystemFont
      default DefaultUseSystemFont;
  end;
  ...
  protected
    property MenuBarUpdating
      : Boolean read FMenuBarUpdating write FMenuBarUpdating default False;
  ...
  public
    ...
    property SelectedItem: TSelectedItem read FSelectedItem write
      SetSelectedItem;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    property Color: TColor index 0 read GetGradientColor write SetGradientColor
      default DefaultColor;
    property ColorTo: TColor index 1 read GetGradientColor write
      SetGradientColor default DefaultColorTo;
    property GradientDirection
      : TGradientDirection read FGradientDirection write
      SetGradientDirection default
      DefaultMenuGradientDirection;
  ...
  published
    ...
    property CheckColor
      : TColor index 0 read GetCheckColor write SetCheckColor
      default DefaultCheckColor;
    property CheckColorTo
      : TColor index 1 read GetCheckColor write SetCheckColor
      default DefaultCheckColorTo;
    property CheckBorder: TColor read FCheckBorder write FCheckBorder default
      DefaultCheckBorder;
    property CheckGradientDirection
      : TGradientDirection read FCheckGradientDirection write
      FCheckGradientDirection default DefaultCheckGradientDirection;
    property RadioColor
      : TColor index 0 read GetRadioColor write SetRadioColor
      default DefaultRadioColor;
    property RadioColorTo
      : TColor index 1 read GetRadioColor write SetRadioColor
      default DefaultRadioColorTo;
    property RadioBorder: TColor read FRadioBorder write FRadioBorder default
      DefaultRadioBorder;
    property RadioGradientDirection
      : TGradientDirection read FRadioGradientDirection write
      FRadioGradientDirection default DefaultRadioGradientDirection;
    property SeparatorColor
      : TColor read FSeparatorColor write FSeparatorColor
      default clNone;
  ...
  published
    ...
    property ColorMirror
      : TColor read FColorMirror write FColorMirror default clNone;
    property ColorMirrorTo
      : TColor read FColorMirrorTo write FColorMirrorTo default
      clNone;
    property GradientDirection default DefaultSelectedGradientDirection;
    property BorderColor: TColor read FBorderColor write FBorderColor default
    ...
    property CheckColor
      : TColor index 0 read GetCheckColor write SetCheckColor
      default DefaultSelectedCheckColor;
    property CheckColorTo
      : TColor index 1 read GetCheckColor write SetCheckColor
      default DefaultSelectedCheckColorTo;
    property CheckBorder: TColor read FCheckBorder write FCheckBorder default
      DefaultSelectedCheckBorder;
    property CheckGradientDirection
      : TGradientDirection read FCheckGradientDirection write
      FCheckGradientDirection default DefaultSelectedCheckGradientDirection;
    property RadioColor
      : TColor index 0 read GetRadioColor write SetRadioColor
      default DefaultSelectedRadioColor;
    property RadioColorTo
      : TColor index 1 read GetRadioColor write SetRadioColor
      default DefaultSelectedRadioColorTo;
    property RadioBorder: TColor read FRadioBorder write FRadioBorder default
      DefaultSelectedRadioBorder;
    property RadioGradientDirection
      : TGradientDirection read FRadioGradientDirection write
      FRadioGradientDirection default DefaultSelectedRadioGradientDirection;
  end;
  ...
  published
    ...
    property UseSystemFont
      : Boolean read FUseSystemFont write SetUseSystemFont
      default DefaultUseSystemFont;
    property SelectedColor: TColor index 0 read GetSelectedColor write
      SetSelectedColor default DefaultRootSelectedColor;
    property SelectedColorTo
      : TColor index 1 read GetSelectedColor write SetSelectedColor
      default DefaultRootSelectedColorTo;
    property SelectedColorMirror
      : TColor index 2 read GetSelectedColor write SetSelectedColor
      default clNone;
    property SelectedColorMirrorTo
      : TColor index 3 read GetSelectedColor write SetSelectedColor
      default clNone;
    property SelectedGradientDirection
      : TGradientDirection read FSelectedGradientDirection write
      FSelectedGradientDirection default DefaultRootSelectedGradientDirection;
    property SelectedBorderColor
      : TColor read FSelectedBorderColor write FSelectedBorderColor
      default DefaultRootSelectedBorder;
    property SelectedTextColor
      : TColor read FSelectedTextColor write FSelectedTextColor default
      DefaultRootSelectedTextColor;
    property HoverColor
      : TColor index 0 read GetHoverColor write SetHoverColor
      default DefaultHoverColor;
    property HoverColorTo
      : TColor index 1 read GetHoverColor write SetHoverColor
      default DefaultHoverColorTo;
    property HoverColorMirror
      : TColor index 2 read GetHoverColor write SetHoverColor default
      clNone;
    property HoverColorMirrorTo
      : TColor index 3 read GetHoverColor write SetHoverColor default
      clNone;
    property HoverGradientDirection
      : TGradientDirection read FHoverGradientDirection write
      FHoverGradientDirection default DefaultMenuGradientDirection;
    property HoverBorderColor
      : TColor read FHoverBorderColor write FHoverBorderColor default
      DefaultHoverBorder;
    property HoverTextColor
      : TColor read FHoverTextColor write FHoverTextColor
      default DefaultHoverTextColor;
  end;
  ...
  protected
    ...
    property OffsetY: Integer read FOffsetY write FOffsetY default
  ...
  public
    ...
    property HighlightColor
      : TColor read FHighlightColor write FHighlightColor
      default DefaultBarCaptionHighlightColor;
    property Menu: TMenu read FMenu;
  published
    ...
    property Font: TFont read FFont write SetFont;
    property ShadowColor: TColor read FShadowColor write FShadowColor default
      DefaultBarCaptionShadowColor;
    property Depth: Integer read FDepth write FDepth default
      DefaultBarCaptionDepth;
    property Direction: TDirection read FDirection write FDirection default
  ...
  protected
    ...
    property Position: TSideBarPosition read FPosition write FPosition default
      DefaultBarSide;
  public
    constructor Create(AMenu: TMenu);
    destructor Destroy; override;
    ...
    property Menu: TMenu read FMenu;
  published
    property Visible: Boolean read GetVisible write SetVisible default
      DefaultBarVisible;
    property VisibleIn
      : TSideBarVisibleIn read FVisibleIn write FVisibleIn default
      DefaultBarVisibleIn;
    ...
    property SplitterColor
      : TColor read FSplitterColor write FSplitterColor default
      DefaultBarSplitterColor;
    property SplitterColorTo
      : TColor read FSplitterColorTo write FSplitterColorTo default
      DefaultBarSplitterColorTo;
    property SplitterWidth
      : Integer read FSplitterWidth write FSplitterWidth default
      DefaultBarSplitterWidth;
    property SplitterMargin
      : Integer read FSplitterMargin write FSplitterMargin
      default DefaultBarSplitterMargin;
    property SplitterGradientWidth: Integer read FSplitterGradientWidth write
      FSplitterGradientWidth default DefaultBarSplitterGradientWidth;
    property SplitterGradientType
      : TGradientType read FSplitterGradientType write
      FSplitterGradientType default DefaultBarSplitterGradientType;
    property BorderColor: TColor read FBorderColor write FBorderColor default
      DefaultBarBorder;
  end;
  ...
  published
    ...
    property Width: Integer read FWidth write FWidth default
      DefaultSeparatorWidth;
    property GradientType: TGradientType read FGradientType write FGradientType;
    property GradientWidth
      : Integer read FGradientWidth write FGradientWidth default
      DefaultSeparatorGradientWidth;
    property Margin: Integer read FMargin write FMargin default
      DefaultSeparatorMargin;
  end;

  { TAdvMainMenu }

  TAdvMainMenu = class(TMainMenu, IAdvMenu {$IFNDEF TMSDOTNET}, IUnknown
    {$ENDIF})
  private
...
{$ENDIF}
    ...
    property Opacity: Byte read GetOpacity write SetOpacity default
      DefaultOpacity;
  ...
  published
    property DisabledImages
      : TImageList read FDisabledImages write FDisabledImages;
    property MenuStyler: TCustomAdvMenuStyler read GetMenuStyler write
      SetMenuStyler;
    property OwnerDraw default True;
    property IntlKeybShortCuts: Boolean read GetIntlKeybShortCuts write
      SetIntlKeybShortCuts default False;
    property ShowNotes
      : Boolean read GetShowNotes write SetShowNotes default True;
    property Version: string read GetVersion write SetVersion;
  end;

  { TAdvPopupMenu }

  TAdvPopupMenu = class(TPopupMenu, IAdvMenu {$IFNDEF TMSDOTNET}, IUnknown
    {$ENDIF})
  private
    { Private declarations }
    FMenuStyler: TCustomAdvMenuStyler;
...
{$ENDIF}
{$IFDEF TMSDOTNET}
      DrawText(ACanvas.Handle, Text, Length(Text), R,
        DT_CALCRECT or DT_SINGLELINE);
{$ENDIF}
...
{$ENDIF}
      ...
      begin
        ...
        DrawMenuItemText(MenuItem, ACanvas,
          AdvShortCutToText(ShortCut, AdvMenu.IntlKeybShortCuts), ARect,
          State, DT_RIGHT);
      end;
    end;
  end;
...
{$ENDIF}
{$IFDEF TMSDOTNET}
        ExtTextOut(Handle, X - ADepth, Y + ADepth, ETO_CLIPPED, R, Caption,
          Length(Caption), nil);
{$ENDIF}
      end;
...
function MenuWindowProc(hWnd: hWnd; uMsg: Integer; WParam: WParam;
  lParam: lParam): LRESULT; {$IFNDEF TMSDOTNET} stdcall; {$ENDIF}
var
  OldWndProc: Integer;
begin
...
begin
  ...
  if AdvMenu.Self is TPopupMenu then
    Inc(Level);
{$IFDEF TMSDOTNET}
  if (IntPtr(GetWindowLong(WindowHandle, GWL_WNDPROC)) <> IntPtr
      (@MenuWindowProc)) then
{$ENDIF}
{$IFNDEF TMSDOTNET}
...
{$ENDIF}
{$IFDEF TMSDOTNET}
  SystemParametersInfo(SPI_SETMENUANIMATION, 0, OldMenuAnimation,
    SPIF_SENDCHANGE);
{$ENDIF}
end;
