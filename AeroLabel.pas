...
uses
  ...
  SysUtils, Math, AdvGDIP, Themes, ImgList, AdvDWM, AdvTBXPVS;
...
procedure DrawBlurredText(WinCtrl: TWinControl; Canvas: TCanvas; Text: string; R, TextR: TRect; Align: TAlignment; BackGround: TColor = clNone);
...
begin
    ...
    begin
      case ImagePos of
        ...
        begin
          ...
          //if not (csDesigning in ComponentState) and FIsAeroVista then
          begin
  ...
  begin
    DrawBlurredText(Self, Self.Canvas, Caption, ClientRect, TextBounds, taLeftJustify);
