...
type
  ...
  //  1.0.0.1 : Fixed : Issue with ItemIndex in TCurvyComboBox
  //  1.0.0.2 : Fixed : Issue with triggering OnChange from selection in TCurvyComboBox

  // todo
  // expose events/properties for doing custom drawing in TCurvyComboBox
...
begin
  ...
  try
    ...
    try
      ...
      p := TGPPen.Create(ColorToARGB($D9D9D9));
...
function TCurvyEdit.GetTabOrder: integer;
begin
...
procedure TCurvyEdit.SetTaborder(const Value: integer);
begin
...
function TCurvyMemo.GetTabOrder: integer;
begin
  Result := FEdit.TabOrder;
end;
...
procedure TCurvyMemo.SetTaborder(const Value: integer);
begin
  FEdit.TabOrder := Value;
end;
...
function TCurvyCombo.GetTabOrder: integer;
begin
  Result := FCombo.TabOrder;
end;
...
procedure TCurvyCombo.SetTaborder(const Value: integer);
begin
  FCombo.TabOrder := Value;
end;
