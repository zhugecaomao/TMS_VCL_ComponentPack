...
function DrawVistaButton(Owner: TControl; Canvas: TCanvas; r: TRect; CFU, CTU, CFB, CTB, PC: TColor;
   ...
   Trimming: TStringTrimming;Notes: TStringList; NotesFont: TFont;Checked, Down: boolean): TSize;
var
...
begin
  ...
  if (not Transparent) or (Down) then
  begin
  ...
  if ((not Transparent) or (Down)) and DrawBorder then
  begin
...
begin
  ...
  try
  if FTransparent and (not FMouseEnter or StaticButton) then
  begin
    // TRANSPARENCY CODE
...
//            PenColor := BlendColor(BorderColorDown, BorderColorChecked, FStepPush);
    ...
    begin
      ...
      sz := DrawVistaButton(Self, Canvas,ClientRect,GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
        ...
        FOverlappedText, FWordWrap, True, FRounded, FDropDownDirection = ddDown, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown);
    ...
    sz := DrawVistaButton(Self, Canvas,ClientRect,GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
      ...
      False, FRounded, FDropDownDirection = ddDown, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown);
